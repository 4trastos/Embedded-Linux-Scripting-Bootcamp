...
while [ $passed -lt 10 ]; do
    ...
    clear
    echo "=============================="
    echo "🧱 Bloque 3 - Ejercicio $ejercicio"
    echo "=============================="
    cat "$enunciado"
    echo ""
    ...
    vim "+set number" "$script"# Crear archivo si no existe
...
# Fin de bloque
echo "🎉 ¡Has completado el Bloque 3!"
echo "Código para desbloquear Bloque 4: CODE-BLOQUE-2-UNLOCK" > unlock_code.txt
